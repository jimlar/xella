...
class GnutellaConnection {
	...
	if (isClient == false && socketChannel == null) {
	...
	if (currentInputBuffer == null) {
	    ...
	    socketChannel.read(currentInputBuffer);
	    System.out.println("initiated header read");
	} else {

	    if (!currentInputBuffer.hasRemaining()) {
		currentInputBuffer.rewind();
		System.out.println("decoding header " + currentInputBuffer.remaining() + " bytes");
	...
	if (currentInputBuffer == null) {
	    ...
	    socketChannel.read(currentInputBuffer);
	    System.out.println("initiated message body read");
		...
		System.out.println("decoding message body " + currentInputBuffer.remaining() + " bytes");
		...
		System.out.println("message body done");
	    }
	}
    }
	...
	if (currentOutputBuffer == null || !currentOutputBuffer.hasRemaining()) {
		...
		numMessagesSent++;
		System.out.println("sent message (size=" + message.size() + ")");
	    }
	}
    }
